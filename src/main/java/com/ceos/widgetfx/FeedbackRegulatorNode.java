...
public class FeedbackRegulatorNode extends Pane implements TileNode {

    private FeedbackRegulator regulator;

    public FeedbackRegulatorNode() {
        setPrefSize(200, 200);
        regulator = new FeedbackRegulator();
        regulator.setPrefSize(200, 200);
        regulator.setMinValue(0);
        regulator.setMaxValue(100);
        regulator.setTargetValue(0);
        regulator.setCurrentValue(0);
        regulator.setColor(Color.web("#c0c0c0"));
        regulator.setTextColor(Color.web("#333333"));
        this.getChildren().add(regulator);
    }

    public FeedbackRegulator getRegulator() { return regulator; }
    ...
    @Override public void setValue(double value) {
        regulator.setCurrentValue(value);
        regulator.setTargetValue(value);
    }
